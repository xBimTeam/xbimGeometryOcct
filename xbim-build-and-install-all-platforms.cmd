...
rem This one command will generate each platforms source, build and deploy the bins to the appropriate folder under Install.
...
set "OCCT_SOURCEDIR=OCCT-7_8_0"

rem Path to Binaries folder (used by each p
